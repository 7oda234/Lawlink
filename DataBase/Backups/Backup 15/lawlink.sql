...
--
-- Host: 127.0.0.1:3307
-- Generation Time: May 25, 2026 at 03:18 PM
...
--
-- Table structure for table `case_deadlines`
--
...
CREATE TABLE `hearings` (
  ...
  `case_id` bigint(20) NOT NULL,
  `hearing_type` varchar(128) DEFAULT NULL,
  `due_date` datetime DEFAULT NULL,
...
--
-- Table structure for table `lawyer_performance`
--
...
CREATE TABLE `lawyer_performance` (
  ...
  `metric_value` decimal(10,4) DEFAULT 0.0000,
  `created_at` datetime NOT NULL DEFAULT current_timestamp(),
  `deleted_at` datetime DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
ALTER TABLE `admin_logs`
  ADD PRIMARY KEY (`log_id`),
  ADD KEY `idx_admin_logs_case_created` (`case_id`,`created_at`);
...
ALTER TABLE `case_activities`
  ...
  ADD KEY `idx_case_activities_case_created` (`case_id`,`created_at`);

--
-- Indexes for table `case_deadlines`
--
ALTER TABLE `case_deadlines`
  ADD PRIMARY KEY (`deadline_id`),
  ADD KEY `idx_case_deadlines_case_due` (`case_id`,`due_date`);
...
ALTER TABLE `case_messages`
  ...
  ADD KEY `idx_case_messages_case_created` (`case_id`,`created_at`);
...
ALTER TABLE `documents`
  ADD PRIMARY KEY (`document_id`),
  ADD KEY `idx_documents_case_uploaded` (`case_id`,`uploaded_at`);
...
ALTER TABLE `escalations`
  ...
  ADD KEY `idx_escalations_case_created` (`case_id`,`created_at`);
...
ALTER TABLE `hearings`
  ...
  ADD KEY `idx_hearings_case_due` (`case_id`,`due_date`);
...
--
-- Indexes for table `lawyer_performance`
--
ALTER TABLE `lawyer_performance`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_lawyer_performance` (`lawyer_id`,`metric_name`,`created_at`);
...
ALTER TABLE `notifications`
  ADD PRIMARY KEY (`notification_id`),
  ADD KEY `idx_notifications_case_created` (`case_id`,`created_at`);
...
--
ALTER TABLE `activity_log`
  MODIFY `log_id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3830;
...
--
-- AUTO_INCREMENT for table `case_deadlines`
--
ALTER TABLE `case_deadlines`
  MODIFY `deadline_id` bigint(20) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `hearings`
  MODIFY `hearing_id` bigint(20) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `lawyer_performance`
--
ALTER TABLE `lawyer_performance`
...
--
ALTER TABLE `case_activities`
  ADD CONSTRAINT `fk_case_activities_case` FOREIGN KEY (`case_id`) REFERENCES `cases` (`case_id`);

--
-- Constraints for table `case_deadlines`
--
ALTER TABLE `case_deadlines`
  ADD CONSTRAINT `fk_case_deadlines_case` FOREIGN KEY (`case_id`) REFERENCES `cases` (`case_id`);

--
-- Constraints for table `case_messages`
--
ALTER TABLE `case_messages`
  ADD CONSTRAINT `fk_case_messages_case` FOREIGN KEY (`case_id`) REFERENCES `cases` (`case_id`);
...
--
ALTER TABLE `documents`
  ADD CONSTRAINT `fk_documents_case` FOREIGN KEY (`case_id`) REFERENCES `cases` (`case_id`);

--
-- Constraints for table `escalations`
--
ALTER TABLE `escalations`
  ADD CONSTRAINT `fk_escalations_case` FOREIGN KEY (`case_id`) REFERENCES `cases` (`case_id`);
...
--
ALTER TABLE `hearings`
  ADD CONSTRAINT `fk_hearings_case` FOREIGN KEY (`case_id`) REFERENCES `cases` (`case_id`);
