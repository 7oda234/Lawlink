...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 05, 2026 at 11:25 AM
...
(1, '15 Talaat Harb Street, Downtown, Cairo', 8),
(2, 'Building 42, Road 9, Maadi, Cairo', 10);
...
INSERT INTO `users` (`user_id`, `name`, `role`, `created_at`, `email`, `gender`, `Phone_no1`, `Phone_no2`, `deleted_at`) VALUES
(7, 'Karim Adel', 'Client', '2026-02-26 07:10:00', 'karim.adel@email.com', 'male', '01012345678', '01087654321', NULL),
(8, 'Laila Mostafa', 'Lawyer', '2026-02-26 08:45:00', 'laila.mostafa@email.com', 'female', '01123456789', '01198765432', NULL),
(9, 'Hassan Tarek', 'Client', '2026-02-26 10:30:00', 'hassan.tarek@email.com', 'male', '01234567890', '01209876543', NULL),
(10, 'Yara Samir', 'Lawyer', '2026-02-26 12:20:00', 'yara.samir@email.com', 'female', '01512345678', '01587654321', NULL),
(11, 'Mohamed Khaled', 'Admin', '2026-02-26 14:00:00', 'Mk71295535@gmail.com', 'male', '01098765432', '01023456789', NULL),
(12, 'Farah Nabil', 'Client', '2026-02-26 15:15:00', 'farah.nabil@email.com', 'female', '01298765432', '01210987654', NULL);
...
--
ALTER TABLE `wallet`
  MODIFY `wallet_id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
