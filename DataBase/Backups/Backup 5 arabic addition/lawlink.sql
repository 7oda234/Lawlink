...
--
-- Host: 127.0.0.1:3307
-- Generation Time: Mar 15, 2026 at 07:48 PM
...
-- Database: `lawlink`
--
CREATE DATABASE IF NOT EXISTS `lawlink` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE `lawlink`;
...
INSERT INTO `users` (`user_id`, `name`, `role`, `created_at`, `email`, `gender`, `Phone_no1`, `Phone_no2`, `deleted_at`, `Date_of_Birth`) VALUES
