    ...
    <main className="flex-grow pt-28 pb-16"> 
      <section className="max-w-6xl mx-auto px-6 py-16"> 
        <div className="bg-white border border-gray-200 rounded-2xl shadow-sm p-10"> 
          <h1 className="text-4xl font-bold text-black mb-3">Upload Case Documents</h1>
          <p className="text-gray-500 mb-8 text-lg">Upload legal documents securely to your case folder.</p>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6"> 
            ...
            <div className="rounded-xl border border-gray-200 p-5"> 
              ...
              <p className="text-gray-700">This page is scaffolded for upload case documents with a bold black-and-white theming and a subtle accent tone consistent with LawLink branding. Extend it with actual fields and business logic as needed.</p>
            </div>
          </div>
        </div>
      </section>
